...
const Productos = () => {
  ...
  const productos = [
    ...
    },
    {
      ...
      beneficios: ["Desintoxicante", "Rico en clorofila", "Antiinflamatorio"],
      rating: 4.9,
      reviews: 89,
    ...
    },
    {
      ...
      beneficios: ["Energía duradera", "Enfoque mental", "Sin cafeína"],
      rating: 4.6,
      reviews: 67,
    ...
    },
    {
      ...
      beneficios: ["Superfood", "Proteína vegetal", "Energía sostenible"],
      rating: 4.9,
      reviews: 45,
      tiempoPreparacion: "7 min",
      esNuevo: true
    },
    {
      ...
      beneficios: ["Digestivo natural", "Piel saludable", "Antioxidante"],
      rating: 4.8,
      reviews: 112,
      tiempoPreparacion: "6 min",
      esNuevo: false
    },
    {
      ...
      beneficios: ["Energía mental", "Resistencia física", "Adaptógeno natural"],
      rating: 4.7,
      reviews: 78,
      tiempoPreparacion: "8 min",
      esNuevo: false
    ...
    },
    {
      ...
      beneficios: ["Desintoxicación hepática", "Diurético natural", "Rico en minerales"],
      rating: 4.9,
      reviews: 56,
      tiempoPreparacion: "7 min",
      esNuevo: true
    },
    {
      ...
      beneficios: ["Hidratante", "Electrolitos naturales", "Refrescante"],
      rating: 4.8,
      reviews: 203,
      tiempoPreparacion: "5 min",
      esNuevo: false
    },
    {
      ...
      descuento: 11,
      stock: 8,
      ingredientes: ["Blueberries", "Romero fresco", "Té verde", "Miel", "Limón"],
      beneficios: ["Enfoque mental", "Memoria", "Antioxidante cerebral"],
      rating: 4.7,
      reviews: 89,
      tiempoPreparacion: "8 min",
      esNuevo: true
